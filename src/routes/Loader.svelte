<main class="container mx-auto px-8 md:px-12 pb-20 pt-12 animate-pulse select-none">
    <div class="flex flex-col md:grid md:grid-cols-2 gap-6 lg:grid-cols-4 mt-4 select-none">
        {#each Array(20) as _, i}
            <li class="hidden">{i + 1}</li>
            <div class="rounded-xl select-none w-full">

                <div class="flex items-center justify-center w-full h-48 bg-gray-300 rounded-xl">
